...
// [PlayerPrefs] scripti oyuncuya ait tercih verilerinin kaydedilmesini sağlar.
public static class Secenekler//MonoBehaviour silindi çünkü bu script oyun objesine ekli bir component olmayacak.
                              //Genel bir classın her yere erişiminin olması lazım.
                              //Class static tipinde oldu çünkü her yerden değişmeden okunacak.
{
    public static string kolay = "kolay";//Ana class static olunca değişkenler ve metotlar da static olmalıdır.
    public static string orta = "orta";
    public static string zor = "zor";

    public static string kolayPuan = "kolayPuan";//Ana class static olunca değişkenler ve metotlar da static olmalıdır.
    public static string ortaPuan = "ortaPuan";
    public static string zorPuan = "zorPuan";

    public static string kolayAltin = "kolayAltin";//Ana class static olunca değişkenler ve metotlar da static olmalıdır.
    public static string ortaAltin = "ortaAltin";
    public static string zorAltin = "zorAltin";

    public static string muzikAcik = "muzikAcik";

    public static void KolayDegerAta(int kolay)//kolay keyinin değeri 0 ya da 1 olacak ancak PlayerPrefs
                                               //boolean tipini desteklemediği için biz int tipinde key tanımlamalıyız.
    {
    ...
    {
        PlayerPrefs.SetInt(Secenekler.zor, zor);//SetInt atama yapar ve veri kaydeder.
    }
    public static int ZorDegerOku()
    {
        return PlayerPrefs.GetInt(Secenekler.zor);//GetInt kayıtlı veriyi okur.
    }
    ...
    public static void KolayAltinDegerAta(int kolayAltin)//kolay keyinin değeri 0 ya da 1 olacak ancak PlayerPrefs
                                                         //boolean tipini desteklemediği için biz int tipinde key tanımlamalıyız.
    {
    ...
    public static bool KayitVarmi()
    {
        if(PlayerPrefs.HasKey(Secenekler.kolay) || 
            PlayerPrefs.HasKey(Secenekler.orta) || PlayerPrefs.HasKey(Secenekler.zor))//HasKey kayitli bir key oluğ olmadığını kontrol eder.
        {
            return true;
        } else
        {
